...
export default function Testing() {
  ...
  return (
    <div className="flex space-x-5 items-center w-full shadow-sm justify-around">
      {/* left side */}
      <blockquote class="text-2xl font-semibold italic text-center text-slate-900">
        <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-500 mx-2 relative inline-block">
          <span class="relative text-white">Geesho</span>
        </span>
        .com
      </blockquote>
      {/* center */}
      <div className="w-1/2   flex  border">
        <Combobox value={selectedPerson} onChange={setSelectedPerson}>
          ...
          <Combobox.Options className="absolute top-14 w-1/2 ">
            {filteredPeople.splice(0, 8).map((person) => (
              <Combobox.Option
                key={person}
                value={person}
      ...
      <h1 className="text-lg cursor-pointer hover:bg-pink-500 p-5 font-bold hover:text-white ">
        Log in
      </h1>
    </div>
  );
